...
export function HowItWorksSection() {
  ...
  return (
    <>
      <section
        id="how-we-work"
        className="bg-[#f3f8f4] px-4 py-12 sm:px-6 lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-3 text-sm text-[#3a3a3a] sm:text-base lg:text-xl">
              You can find the best Security Services here. Start your search
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:mt-10 lg:grid-cols-3 lg:gap-8">
            {serviceSteps.map((step) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-7 text-[#7a7a7a] sm:text-[16px]">
                  {step.body}
                </p>
              </article>
            ))}
          ...
          <p className="mx-auto mt-7 max-w-5xl text-center text-sm leading-7 text-[#3a3a3a] sm:mt-8 sm:text-[18px] sm:leading-8">
            First time looking for a Security Service and not sure where to
            start? Tell us about your project and we&apos;ll send you a list of
            Security Services to review. There&apos;s no pressure to hire, so
          ...
          <div className="mt-7 text-center sm:mt-8">
            ...
            <button
              ...
              className="shine-button mx-auto mt-3 inline-flex h-11 items-center justify-center rounded-[8px] bg-[#123D7A] px-6 font-[family-name:var(--font-public-sans)] text-xs font-bold tracking-[0.016em] text-white sm:h-12 sm:px-8 sm:text-[15px]"
            >
              Get Quote from Security Services
            </button>
          </div>
        </div>
      </section>
