    ...
    <section className="bg-[#f3f8f4] px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="text-center">
          ...
          <p className="mt-3 text-[18px] text-[#3a3a3a]">
        ...
        <div className="mt-8 space-y-3">
          {faqs.map((faq) => (
            <details
              key={faq.question}
              className="group rounded-[11px] bg-white px-4 py-5 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.11)]"
            >
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-[family-name:var(--font-poppins)] text-sm text-[#1f1d1d]">
              ...
              <div className="mt-4 text-[13.6px] leading-6 text-[#3a3a3a]">{faq.answer}</div>
            </details>
          ))}
        </div>
      </div>
