      ...
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 py-2 sm:px-6 sm:py-2 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        ...
        <div className="relative flex items-center justify-center lg:min-h-55 lg:justify-start">
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <ContactUsButton className="shine-button mt-6 inline-flex h-11 items-center justify-center rounded-md bg-[#0ba8dd] px-6 font-(family-name:--font-public-sans) text-xs font-bold tracking-[0.14em] text-white shadow-[3px_4px_0px_0px_#3d3d3d] transition hover:-translate-y-px hover:bg-[#123D7A] sm:h-12 sm:text-sm" />
          </div>
        </div>
      </div>
    </section>
