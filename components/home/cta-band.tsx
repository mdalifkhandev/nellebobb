  ...
  return (
    <section className="relative overflow-hidden bg-[#015555]">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 py-12 sm:px-6 sm:py-14 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div className="relative mx-auto max-w-[280px] sm:max-w-sm lg:mx-0">
          <img
            src={ctaPortrait}
        ...
        <div className="relative flex items-center justify-center lg:min-h-[220px] lg:justify-start">
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <a
              href="#"
              className="mt-6 inline-flex h-11 items-center justify-center rounded-md bg-[#0ba8dd] px-6 font-[family-name:var(--font-public-sans)] text-xs font-bold tracking-[0.14em] text-white shadow-[3px_4px_0px_0px_#3d3d3d] transition hover:translate-y-[-1px] hover:bg-[#19b5e5] sm:h-12 sm:text-sm"
            >
              Contact Us
            </a>
          </div>
